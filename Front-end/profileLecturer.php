      ...
      <div class="tab-content" id="myTabContent">
        ...
        <div class="tab-pane fade" id="myprofile" role="tabpanel" aria-labelledby="myprofile-tab">
          <div class="card" style="width: 18rem;">
            <img class="card-img-top" src="https://upload.wikimedia.org/wikipedia/en/thumb/b/b5/DTU%2C_Delhi_official_logo.png/200px-DTU%2C_Delhi_official_logo.png" alt="Card image cap">
            <div class="card-body">
              <?php
