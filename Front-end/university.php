...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand" href="student_index.php">DTU</a>
      ...
      <div id="accordion">
            ...
            <div class="card-body">
                ...
                <form method="post" action="university.php" > 
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <input name="book_name" type="text" class="form-control" id="inlineFormInputName1" placeholder="Eg: The Lord of the Rings">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="inlineFormInputName2" class="col-sm-2 col-form-label">Author</label>
                      <div class="col-sm-10">
                        <input name="book_author" type="text" class="form-control" id="inlineFormInputName2" placeholder="Eg: J. R. R. Tolkien">
                      </div>
                    </div>
                    <div class="form-group row">
                      <div class="col-sm-10">
            ...
            <div class="card-body">
                  <div class="card-group">
                    <div class="card">
                      ...
                      <div class="card-body">
                        <h5 class="card-title">Engifest</h5>
                        <form method="post" action="university.php">
                    ...
                    <div class="card">
                      ...
                      <div class="card-body">
                        <h5 class="card-title">E-cell DTU</h5>
                        <form method="post" action="university.php">
                    ...
                    <div class="card">
                      <img class="card-img-top" src="https://.twimg.com/profile_images/809668910584889346/79t7M5gb_400x400.jpg" alt="Card image cap">
                      <div class="card-body">
                        <h5 class="card-title">Cultural Council</h5>
                        <form method="post" action="university.php">
        ...
        <div class="card">
            ...
            <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordion">
              <div class="card-body">
                <div class="jumbotron">
                    <h1 class="display-4">Engifest</h1>
              ...
              <div class="jumbotron">
                <h1 class="display-4">E-cell DTU</h1>
                <p class="lead">This is a simple hero unit, a simple jumbotron-style component for calling extra attention to featured content or information.</p>
                <hr class="my-4">
                <p>It uses utility classes for typography and spacing to space content out within the larger container.</p>
                <p class="lead">
